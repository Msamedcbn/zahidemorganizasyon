...
import { services, siteConfig, districts } from "@/lib/data";
...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return {
    title: `${service.title} | Zahidem Organizasyon`,
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-10 mb-20">
          <div className="md:col-span-2">
            ...
            <div className="prose prose-lg max-w-none text-muted leading-relaxed space-y-4">
              ...
              <p>
                Zahidem Organizasyon olarak, {service.title.toLowerCase()} hizmetimizde
                kaliteyi, müşteri memnuniyetini ve hayal ettiğiniz organizasyonu gerçeğe
                dönüştürmeyi ön planda tutuyoruz.
              </p>
            </div>
          </div>
            ...
            <GlassCard className="p-6 sticky top-28">
              ...
              <div className="space-y-4">
                ...
                <a
                  ...
                  className="w-full bg-primary text-white px-4 py-3 rounded-full text-sm font-semibold hover:bg-primary-dark transition-colors text-center block"
                >
                  WhatsApp&apos;tan Yaz
                </a>
              </div>
        ...
        <div className="mb-16">
          ...
          <div className="flex flex-wrap gap-2">
            {districts.map((d) => (
              <span key={d} className="glass-card !px-3 !py-1.5 text-xs text-muted">
                {d}
              </span>
            ))}
          </div>
