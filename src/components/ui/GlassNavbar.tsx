      ...
      <div className="bg-background/95 backdrop-blur-md mx-4 mt-4 rounded-2xl px-6 py-3 max-w-7xl lg:mx-auto shadow-lg shadow-black/5 border border-white/20">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href={`https://wa.me/${whatsapp}`} className="bg-primary text-white px-4 py-2 rounded-full text-sm font-semibold hover:bg-primary-dark transition-colors">Hemen Teklif Al</a>
          </div>
        </div>
      </div>
    </nav>
